...
const TitleRounded = ({ title, id, subTitle }) => {
  return (
    <div id={id} className=" flex flex-col justify-center w-full relative mt-12 mb-6 pt-5 sm:mt-20 sm:pt-6">
      <div className=" flex justify-center w-full relative">
        <span className="z-9 bg-[#181818] text-xs sm:text-xl  px-4 py-2 text-lime-400 border-2 border-[#c4b8b86b] rounded-full">
          {title.toUpperCase()}
        </span>
